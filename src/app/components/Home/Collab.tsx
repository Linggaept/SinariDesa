    ...
    <>
      <section className="w-full">
        <div className="w-3/4 mx-auto p-10 md:p-20">
          <h1 className="text-yellow-700 font-bold text-xl md:text-3xl text-center mb-20">
          ...
          <div className="flex flex-col md:grid md:grid-cols-2 md:items-start items-center">
            ...
            <div className="flex flex-col gap-10 text-center md:text-left">
              <h1 className="text-yellow-700 font-bold text-2xl lg:text-5xl">
              ...
              <Link href={"#"}>
                <div className="flex md:items-start items-center md:justify-start justify-center">
                  <div className="bg-yellow-700 p-4 rounded-3xl w-3/4 cursor-pointer hover:bg-yellow-600 hover:shadow-xl hover:shadow-yellow-600 duration-300 animate-bounce">
