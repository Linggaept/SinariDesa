      ...
      <section className="w-full bg-gray-900 min-h-screen">
        <div className="w-3/4 mx-auto p-5 md:p-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <GiStarSwirl className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <GiPuzzle className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <GrServices className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <GiPodiumWinner className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <GiLaurelsTrophy className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
            ...
            <div className="p-4 bg-green-700 rounded-xl md:flex gap-4">
              <FaSpaceAwesome className="w-24 h-24 text-white mb-4 md:mb-0" />
              <div className="flex flex-col gap-2 w-11/12">
                <h1 className="text-white font-bold text-sm md:text-xl">
